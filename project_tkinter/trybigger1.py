...
def main():
    ...
    def choose():
        ...
        # l = Label(root1, text="Are you a new user?", font="licida 19 bold italic", fg="#5DADE2", bg="#16A085")
        # l.place(x=580, y=150)
        # radio1 = Radiobutton(root1, text="Yes",font="licida 13 bold", value=1, variable=var, pady=4, padx=12, bg="#2874A6", fg="white",
        #                      height=2)
        # radio2 = Radiobutton(root1, text="No", value=2, font="licida 13 bold",variable=var, pady=4, padx=14, bg="#2874A6", fg="white",
        #                      height=2)
        # radio1.place(x=580, y=200)
        # radio2.place(x=680, y=200)
        #
        # def choose1():
        #     if var.get() == 1:
        #
        ...
        # b1 = Button(root1, text="SELECT", font="licida 19 bold", fg="#A2D9CE", bg="#16A085", command=choose1).place(
        #     x=700, y=270)
        l2 = Label(text="ENTER USER ID", bg="#48C9B0", padx=5, pady=5, font="arial 15 bold").place(x=630, y=100)
    ...
    # changeOnHover(admin_submit, "#B03A2E", "#117864")
    # photo = PhotoImage(file="cmrit.png")
    # images = Label(c1,image=photo,pady=20)
    # images.place(x=30, y=20)
    ...
    # l1=Label(c1,text="click client to fill reg form",fg="light yellow").place(x=40,y=460)
    root1.mainloop()
# main()